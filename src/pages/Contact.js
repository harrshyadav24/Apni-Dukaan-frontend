      ...
      <div className="container about">
        <div className="row about_cont d-flex flex-row">
          ...
          <div className="col-md-6 abt_right">
            ...
            If You have any query and want information about prodduct feel free to call anytime we are 24X7 avaialible.
          </p>
          <p className="mt-3 cont_p">
            <BiMailSend /> : harrshyadav24@gmail.com
          </p>
          <p className="mt-3 cont_p">
            <BiPhoneCall /> : 9695703517
          </p>
          <p className="mt-3 cont_p">
            <SlSocialLinkedin /> : <Link to="https://www.linkedin.com/in/harsh-yadav-4b5629214/" className="text-decoration-none" style={{color:"#617d98"}}> Harsh Yadav</Link>
          </p>
          <p className="mt-3 cont_p">
